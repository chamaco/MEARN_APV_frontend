...
const Registrar = () => {
  ...
  const handleSubmit = async (e) =>{
    ...
    if (password !== repetirpassword) {
      setAlerta({msg: 'los password no son iguale', error: true})
      return
    }
          ...
          <div className='mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-lg bg-white'>
            ...
            >
                ...
                <div className="my-5">
                    ...
                    <input type="email" placeholder="Tu Email de Registro" className="border w-full p-3 mt-3 bg-gray-50 rounded-xl" value={email} onChange={e => setEmail(e.target.value)}/>                   
                </div>
                <div className="my-5">
                    <label className="uppercase text-gray-600 block text-xl font-bold">
                        Password
