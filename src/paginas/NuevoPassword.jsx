...
import { useParams, Link } from 'react-router-dom' //Para obtener el valor de la URL
...
const NuevoPassword = () => {
  ...
  return (
      <>
        <div>
          <h1 className="text-indigo-600 font-black text-6xl">Reestrablece tu password y no pierdas el acceso a {" "}<span className="text-black">tus Pacientes</span> </h1>
        </div>
        ...
        <div className='mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-lg bg-white'>
          ...
          {passwordModificado && 
            <Link className='block text-center my-5 text-gray-500' to="/">Iniciar Sesion
            </Link>}
