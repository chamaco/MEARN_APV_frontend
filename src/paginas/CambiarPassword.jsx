          ...
          <div className="w-full md:w-1/2 bg-white shadow rounded-lg p-5">
            ...
            <form onSubmit={handleSubmit}>
                <div className="my-3">
                    ...
                    <input type="password" className="border bg-green-50 w-full p-2 mt-5 rounded-lg" name="pwd_actual"
                ...
                <div className="my-3">
                    ...
                    <input type="password" className="border bg-green-50 w-full p-2 mt-5 rounded-lg" name="pwd_nuevo"
                      placeholder="Escribe tu Password Nuevo" onChange={e => setPassword({
                        ...password, [e.target.name] : e.target.value
                      })}              
                    />
                </div>
