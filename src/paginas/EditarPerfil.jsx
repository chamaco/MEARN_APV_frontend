...
const EditarPerfil = () => {
  ...
  return (
    <>
      <AdminNav />
      <h2 className="font-black text-3x text-center mt-10">Editar Perfil</h2>
          ...
          <div className="w-full md:w-1/2 bg-white shadow rounded-lg p-5">
            ...
            <form onSubmit={handleSubmit}>
                <div className="my-3">
                    ...
                    <input type="text" className="border bg-green-50 w-full p-2 mt-5 rounded-lg" name="nombre"
                    value={perfil.nombre || ''}
                ...
                <div className="my-3">
                    ...
                    <input type="text" className="border bg-green-50 w-full p-2 mt-5 rounded-lg" 
                    name="web"
                    value={perfil.web || ''}
                    onChange={e => setPerfil({
                      ...perfil,
                ...
                <div className="my-3">
                    ...
                    <input type="text" className="border bg-green-50 w-full p-2 mt-5 rounded-lg" name="telefono"
                ...
                <div className="my-3">
                    ...
                    <input type="text" className="border bg-green-50 w-full p-2 mt-5 rounded-lg" name="email" 
                    value={perfil.email || ''}
                    onChange={e => setPerfil({
                      ...perfil,
                      [e.target.name] : e.target.value
